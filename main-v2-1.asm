...
;=============================================================================
;
;	Timestamp Timer TCA0
;
;	Timer A is used as the timestamp for logging messages, we just use
;	a 8-bit counter. We use the counter in split mode, in this mode
;	the counter just counts down from PER to ZERO and the restarts at
;	PER
;
;	We use a prescaler of 1024, one tick corresponds to 32usec
;	We use a prescaler of 256, one tick corresponds to 8usec
;
	...
	ldi	r18, TCA_SINGLE_CLKSEL_DIV1024_gc | TCA_SINGLE_ENABLE_bm
	ldi	r18, TCA_SINGLE_CLKSEL_DIV256_gc | TCA_SINGLE_ENABLE_bm
